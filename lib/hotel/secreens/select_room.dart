...
//                                             ),
//                                             Text(
//                                               cubit.selectedCurrency.last == 'USD'
//                                                   ? "\$ ${Room[index]['price']}"
//                                                   : "SYP  ${Room[index]['price'] * 14500}",
//                                               style: TextStyle(
//                                                   fontSize: 16.sp,
...
//                                                           children: [
//                                                             Text(
//                                                               "Total for ${widget.numNight} night *  ${cubit.num_room==2? cubit.roomSelectionCount == 1 ? cubit.countA1 : cubit.countA2 :cubit.countA1 } person",
//                                                               style: TextStyle(
//                                                                   fontSize:
//                                                                       15.sp,
//                                                                   color: Colors
...
//                                               ElevatedButton(
//                                                 onPressed: () async {
//                                                   print(cubit.selectedCurrency.last);
//
...
//                                                         MaterialPageRoute(
//                                                           builder: (context) {
//                                                             return PaymentSelectionPage(total: totalPrice1);
//                                                           },
//                                                         ),
//                                                       );
//                                                     } else {
...
//                                                       builder: (BuildContext context) {
//                                                         return AlertDialog(
//                                                           content: Text("Please select another room"),
//                                                           actions: [
//                                                             TextButton(
//                                                               onPressed: () => Navigator.pop(context),
//                                                               child: Text("Ok"),
...
//                                                     bed1 = "${Room[index]['type']}";
//                                                     priceNight1 = Room[index]['price'];
//                                                     Adults1 = cubit.countA1;
//                                                     children1 = cubit.selectedAge1.length;
//                                                     totalPrice1 = numNight != 1 ? (priceNight1! * numNight!) ~/ 1.1 : priceNight1! * numNight!;
//                                                     id1 = Room[index]['id'];
//                                                   } else {
//                                                     nameHotel = widget.nameHotel;
//                                                     image = widget.image;
...
//                                                       id2 = Room[index]['id'];
//                                                     } else {
//                                                       bed2 = "${Room[index]['type']}";
//                                                       priceNight2 = Room[index]['price'];
//                                                       Adults2 = cubit.countA2;
//                                                       children2 = cubit.selectedAge2.length;
//                                                       id2 = Room[index]['id'];
//                                                       totalPrice = numNight != 1 ? (priceNight2! * numNight!) ~/ 1.1 : priceNight2! * numNight!;
//                                                     }
//                                                   }
//                                                 },
...
//         'city': city,
//         'nameHotel': nameHotel,
//         'priceNight1': priceNight1,
//         'priceNight2': priceNight2,
//         'bed1': bed1,
//         'bed2': bed2,
//         'image': image[0],
//         'image1':image[1],
...
//         'checkOut': checkOut,
//         'numNight': numNight,
//         'totalPrice': totalPrice1! + totalPrice1! ,
//         'id1': id1,
//         'id2': id2,
//         'avaliable': false
//
